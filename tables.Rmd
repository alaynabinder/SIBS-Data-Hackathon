...
pander(proportions_df, caption = "Proportions of Patients in Na_Blood Buckets", add.header = c('Sodium in Serum Measures', 'Before Imputation Frequency', 'After Imputation Frequency'))
