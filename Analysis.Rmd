...
>>>>>>> 8490d60246e67e7a0bb08545aba9dfcdcf7e64d2
```
...
# STENOK_AN + np_01 + AGE + IBS_POST + n_r_ecg_p_06 + n_p_ecg_p_11 + 
# L_BLOOD + K_SH_POST + GT_POST + zab_leg_01 + TIME_B_S + lat_im + 
# ANT_CA_S_n + n_p_ecg_p_03 + ritm_ecg_p_04 + ritm_ecg_p_07 + np_10 + n_r_ecg_p_09 +
# TIKL_S_n + GEPAR_S_n + zab_leg_02 + n_p_ecg_p_08 + nr_01 + O_L_POST +
# endocr_01 + FIB_G_POST + n_r_ecg_p_05 + MP_TP_POST + nr_03
# 29 variables, AIC = 956.28
...
# STENOK_AN + np_01 + AGE + IBS_POST + zab_leg_01 + zab_leg_02 + 
# nr_03, endocr_01, nr_11 + nr_04
# 10 variables, AIC = 1004.4
...
#  GT_POST + K_SH_POST + lat_im + D_AD_ORIT
# 4 variables: AIC = 1047
...
# R_AB_3_n + NA_R_2_n + GEPAR_S_n + TRENT_S_n + NA_R_1_n + ANT_CA_S_n + LID_S_n
# 7 variables: AIC = 1020.2
...
# ritm_ecg_p_07 + TIME_B_S + n_p_ecg_p_11 + n_r_ecg_p_06 + n_r_ecg_p_07 + L_BLOOD + 
# n_r_ecg_p_09 + n_r_ecg_p_08
# 8 variables, AIC = 1037.5
```
