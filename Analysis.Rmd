...
# backwards selection admission
model.admit <- glm(REC_IM ~., data=imputed_data_admission,family='binomial')

bfit.admit <- model.admit %>% stepAIC(direction='backward',trace=FALSE)
summary(bfit.admit)
